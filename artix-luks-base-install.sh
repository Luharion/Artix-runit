...
# Proper usage checks.
[ -z "$1" ] && echo "Usage:
artix-luks-base-install dev/sdX encrypt3dpassw0rd" && exit
...
artix-chroot /mnt sh -c 'echo root:123 | chpasswd'
...
echo "4rt1x" > /mnt/etc/hostname
echo '127.0.0.1 localhost
::1 localhost
127.0.1.1 4rt1x.localdomain 4rt1x' >> /mnt/etc/hosts
...
artix-chroot /mnt sh -c 'ln -sf /usr/share/zoneinfo/right/America/Chicago /etc/localtime && hwclock -w'
